 ...
 *         Date 12-6-26
 */
public class CheckVehicleStatusTask extends GenericRemoteTask<String> {
	private Activity activity;

	public CheckVehicleStatusTask(Activity activity) {
		super(activity);
	...
	protected String getRemoteServiceAPIUrl() {
		return HuoDiConstants.API_CHECK_VEHICLE_STATUS;
	}
